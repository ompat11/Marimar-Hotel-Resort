...
<div class="super_container">
  <header class="header">
    <div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
      ...
      <!-- Logo -->
       <div class="logo"><a href="#"><img class="logo_1" src="<?php echo WEB_ROOT;?>images/Marimar_Hotel___Resort-removebg-preview.png" alt=""><img class="logo_2" src="<?php echo WEB_ROOT;?>images/Marimar_Hotel___Resort-removebg-preview.png" alt=""><img class="logo_3" src="<?php echo WEB_ROOT;?>images/Marimar_Hotel___Resort-removebg-preview.png" alt=""></a></div>
...
<!--         <div class="search_button">
  ...
  <div class="logo_overlay">
    <div class="logo_overlay_content d-flex flex-column align-items-center justify-content-center">
      <!--<div class="logo"><a href="#"><img src="<?php echo WEB_ROOT;?>images/Marimar_Hotel___Resort-removebg-preview.png" alt=""></a></div>-->
    </div>
  </div>
  ...
  <div class="menu">
    ...
    <ul class="d-flex flex-row align-items-center justify-content-start">
        <li><a href="https://www.facebook.com" target="_blank">Facebook <i class="fa fa-facebook" aria-hidden="true"></i></a></li>
        <li><a href="https://www.instagram.com" target="_blank">Instagram <i class="fa fa-instagram" aria-hidden="true"></i></a></li>
        <li><a href="https://www.twitter.com" target="_blank">Twitter <i class="fa fa-twitter" aria-hidden="true"></i></a></li>
    </ul>
</div>
  ...
  <div class="home">
    ...
    <div class="home_container d-flex flex-column align-items-center justify-content-center">
      ...
      Enjoy luxury, comfort, and top-class service for a perfect stay. Relax and unwind in a beautiful and peaceful place.
      </div>
      ...
      <div class="row">
        <div class="col">
          <div class="footer_logo text-center">
            <a href="#"><img src="images/Marimar_Hotel___Resort-removebg-preview.png" alt=""></a>
          </div>
